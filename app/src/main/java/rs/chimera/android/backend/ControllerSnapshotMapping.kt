    ...
    ConnectionsSnapshot(
        connections = connections.map { connection ->
            ConnectionSnapshot(
                ...
                destinationIp = connection.metadata.destinationIp.orEmpty(),
                sourcePort = connection.metadata.sourcePort?.toString().orEmpty(),
                destinationPort = connection.metadata.destinationPort.toString(),
            )
        },
